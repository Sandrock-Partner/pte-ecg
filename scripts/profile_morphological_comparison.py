...
from src.pte_ecg.features import _morph_single_patient, _get_r_peaks
...
def main():
    ...
    if 'fastest_method' in all_results[500.0] and 'fastest_method' in all_results[80.0]:
        ...
        print(f"{'Fastest Method Time (s)':<30} {fastest_time_500:<15.4f} {fastest_time_80:<15.4f} {fastest_time_500/fastest_time_80:<15.2f}")
